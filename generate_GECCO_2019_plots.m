...
[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem1', [], false, [4.5 4.5], [0.5 0.5], 5, 2);
...
[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem1', [], true, [4.5 4.5], [0.5 0.5], 5, 2);
...
[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem2', [], false, [4.5 4.5], [0.5 0.5], 5, 2);
figure; DNO=plot_PLOS_net(X,Y,state,neighbours,5,10);

[A,B,EE,C,PO] = process_d_lon(X,Y,w,YY,state, neighbours);
figure; generate_lon(B, C,EE, [],10,50);

[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem2', [], true, [4.5 4.5], [0.5 0.5], 5, 2);
[V,B,Adj,EE,C] = process_p_lon(X,Y,state,neighbours);
figure; generate_lon(B, C,EE, [],10,50,Adj);
...
[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem3', Meta, false, [39.5 39.5], [0.5 0.5], 40, 5);
figure; DNO=plot_PLOS_net(X,Y,state,neighbours,1.5,3);
 
[A,B,EE,C,PO] = process_d_lon(X,Y,w,YY,state, neighbours);
figure; generate_lon(B, C,EE, [],10,50);
 
[X,Y,w,YY,state,neighbours] = exaustive_generate_lon('gecco_workshop_2019_problem3', Meta, true, [39.5 39.5], [0.5 0.5], 40, 5);
[V,B,Adj,EE,C] = process_p_lon(X,Y,state,neighbours);
